...
class State:
    ...
    def is_terminal(self):
        ...
        return not (is_red and is_black)
    ...
    def get_solution(self, output_file, running_time=0):
        """
...
class Solver:
    ...
    def play_game(self):
        ...
        """
        if self.curr_state.is_terminal():  # Assuming all game must terminate and red must win
    ...
    def max_value(self, state, alpha, beta, depth_limit):
        ...
        if state.is_terminal():
            return state, state.get_utility()
